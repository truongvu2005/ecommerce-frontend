    ...
    <header className="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          {/* --- THANH TÌM KIẾM PC (DÙNG HTML FORM) --- */}
          <form action="/products" method="GET" className="relative">
            <input 
              type="text" 
              name="search"  /* <-- Rất quan trọng: Tự động tạo ?search=... */
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4 space-y-4 shadow-xl absolute w-full left-0 animate-fade-in">
          ...
          {/* --- THANH TÌM KIẾM MOBILE (DÙNG HTML FORM) --- */}
          <form action="/products" method="GET" className="relative">
            <input 
              type="text" 
              name="search" /* <-- Rất quan trọng: Tự động tạo ?search=... */
            ...
            />
            {/* Nút ẩn để Submit khi bấm Enter trên đt */}
